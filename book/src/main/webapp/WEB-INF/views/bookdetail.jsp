    ...
    <main>
      ...
      <div class="main">
        <section class="module">
          <div class="container">
            <div class="row"> 
              <div class="col-sm-6 mb-sm-40"><a class="gallery" href="assets/images/shop/product-7.jpg"><img src="${detail.bkimg }" alt="Single Product Image"/></a>
              ...
              <div class="col-sm-6">
                ...
                <div class="row mb-20">
                  <div class="col-sm-12">
                    <div class="price font-alt"><span class="amount">${detail.price }</span></div>
                  </div>
                </div>
                <div class="row mb-20">
                  <div class="col-sm-12">
                    <div class="description">
                      <p>${detail.bkcontent }</p>
                    </div>
                  </div>
                </div>
                <div class="row mb-20">
